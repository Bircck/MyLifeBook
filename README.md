...
An open-source project for telling a person's life through facts, stories, photographs, and other media, with the potential to publish as a website, a book, or a selected collection.
...
- [Discovery record](docs/discovery.md)
...
The public repository is for software, documentation, and explicitly fictional examples. Personal biography material belongs in a separate private location. No personal vault or albums have been imported.

## License

MIT; see [LICENSE](LICENSE). This covers repository contributions, not rights to a user's personal stories, photographs, or third-party media. MIT is the initial project default and was not a specific license choice made in the discovery interview.
